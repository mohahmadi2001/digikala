    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(upload_to='category_image', verbose_name='Icon')),
                ('image', models.ImageField(upload_to='category_image', verbose_name='ّImage')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.category', verbose_name='Category')),
            ],
            options={
